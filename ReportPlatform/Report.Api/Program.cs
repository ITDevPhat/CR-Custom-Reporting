...
builder.Services.AddScoped<IRawCsvExportService, RawCsvExportService>();
builder.Services.AddScoped<IExecutionReportExportService, TelerikExecutionReportExportService>();
builder.Services.AddPowerBIEmbedLab(builder.Configuration);
...
builder.Services.AddSingleton<Telerik.Reporting.Services.IReportSourceResolver, SnapshotReportSourceResolver>();
...
builder.Services.AddSingleton<IReportServiceConfiguration>(sp =>
{
    ...
    return new ReportServiceConfiguration
    {
        ...
        ReportSourceResolver = sp.GetRequiredService<Telerik.Reporting.Services.IReportSourceResolver>()
    };
});
